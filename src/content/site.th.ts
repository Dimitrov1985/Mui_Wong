...
export const site: Site = {
  ...
  pricing: {
    eyebrow: "ราคา",
    title: "เลือก",
    titleScript: "แพ็กเกจของคุณ",
    lede: "ซื้อทีละครั้งหรือเลือกแพ็กเกจเพื่อประหยัดกว่า ทุกแบบเริ่มต้นด้วยการปรึกษาฟรี",
    popularLabel: "ยอดนิยม",
    cta: "จองแพ็กเกจนี้",
    formBack: "ย้อนกลับ",
    formDone: "เสร็จสิ้น",
    footnote:
      "ราคาต่อแพ็กเกจ และครั้งที่ซื้อไม่มีวันหมดอายุ ไม่แน่ใจว่าแบบไหนเหมาะกับคุณ? ทักมาคุยกันได้เลย บทสนทนาแรกไม่มีค่าใช้จ่าย",
    plans: [
      {
        id: "single",
        name: "1 ครั้ง",
        ...
        period: "/ ครั้ง",
        summary:
          "หนึ่งเซสชันทดลอง ไม่ต้องผูกมัด — เหมาะสำหรับลองก่อนตัดสินใจซื้อแพ็กเกจ",
        features: [
          "เทรนเต็มเซสชัน",
          "ไม่ต้องซื้อแพ็กเกจ",
          "จองเวลาที่สะดวก",
      ...
      {
        id: "ten",
        name: "แพ็กเกจ 10 ครั้ง",
        tagline: "ประหยัด ฿500",
        price: "฿4,500",
        period: "/ 10 ครั้ง",
        summary:
          "10 ครั้ง ในราคาครั้งละ 450 บาท — ใช้ได้ตามสะดวก ไม่มีวันหมดอายุ",
        features: [
          "฿450 ต่อครั้ง",
          "ประหยัด ฿500 เทียบกับซื้อทีละครั้ง",
          "ไม่มีวันหมดอายุ",
        ],
        popular: true,
      },
      {
        id: "twenty",
        name: "แพ็กเกจ 20 ครั้ง",
        tagline: "ประหยัด ฿1,500",
        price: "฿8,500",
        period: "/ 20 ครั้ง",
        summary:
          "20 ครั้ง ในราคาครั้งละ 425 บาท — คุ้มที่สุดต่อครั้ง สำหรับผลลัพธ์ระยะยาว",
        features: [
          "฿425 ต่อครั้ง",
          "ประหยัด ฿1,500 เทียบกับซื้อทีละครั้ง",
          "ไม่มีวันหมดอายุ",
          "ราคาต่อครั้งดีที่สุด",
        ],
        popular: false,
      },
    ],
  ...
  contact: {
    ...
    goals: ["ลดน้ำหนัก", "เพิ่มกล้ามเนื้อ", "รักษาหุ่น"],
    submit: "ส่งคำขอ",
    submitting: "กำลังส่ง…",
