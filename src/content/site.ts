    ...
    plans: [
      {
        ...
        period: "/ session",
        summary:
          "One training session, no commitment — a good way to try a session before buying a package.",
        features: [
      ...
      },
      {
        ...
        period: "/ 10 sessions",
        summary:
          "Ten sessions at ฿450 each — book them at your own pace, they never expire.",
        features: [
          "฿450 per session",
      ...
      },
      {
        ...
        period: "/ 20 sessions",
        summary:
          "Twenty sessions at ฿425 each — the best per-session rate, for real long-term progress.",
        features: [
          "฿425 per session",
          "Save ฿1,500 vs single sessions",
          "Sessions don't expire",
