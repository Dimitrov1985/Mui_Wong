...
export const site = {
  ...
  contact: {
    ...
    lede: "Leave your details and I'll message you on WhatsApp within the hour. The first consultation is free.",
    nameLabel: "Your name",
    ...
    note: "Tapping the button opens WhatsApp with your message ready to send.",
